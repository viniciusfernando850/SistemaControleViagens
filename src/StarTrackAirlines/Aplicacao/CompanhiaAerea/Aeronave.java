...
import StarTrackAirlines.Aplicacao.CompanhiaAerea.Assentos.Modelos;
import StarTrackAirlines.Aplicacao.CompanhiaAerea.Assentos.PrimeiraClasse;
import StarTrackAirlines.Aplicacao.CompanhiaAerea.Assentos.Executiva;
import StarTrackAirlines.Aplicacao.CompanhiaAerea.Assentos.Economica;
...
public class Aeronave {
    ...
    public Aeronave(String modelo) {
        ...
        if(modelo.equalsIgnoreCase(Modelos.AIRBUS_A320.getNome())){
            this.modelo = Modelos.AIRBUS_A320.getNome();
            ...
            this.modelo = Modelos.EMBRAER_195.getNome();
            ...
            this.modelo = Modelos.ATR_72.getNome();
            ...
            this.modelo = Modelos.AIRBUS_A350.getNome();
            ...
            this.modelo = Modelos.BOEING_787_DREAMLINER.getNome();
            ...
            this.modelo = Modelos.BOEING_777.getNome();
    ...
    public Map<String, Assento> gerarAssentos() {
